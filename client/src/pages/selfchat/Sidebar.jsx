...
const sidebar = () => {
  ...
  const filteredUsers = input.length!=0?users.filter((user)=>
  ...
  <div
    className={`bg-[#8185B2]/10 h-full w-full p-5 rounded-r-xl overflow-y-scroll text-white  `}
  >
    <div className="pb-5">
